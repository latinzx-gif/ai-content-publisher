    ...
    <div className="flex flex-col h-full bg-white overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-2 border-b border-[#ececec] flex-shrink-0 h-[46px]">
        <div className="flex items-center gap-1.5 text-[13px]">
          <div className="w-[20px] h-[20px] rounded-[5px] bg-[#16a34a] flex items-center justify-center text-white text-[10px] font-bold flex-shrink-0">
            O
          </div>
          ...
          <ChevronDown size={12} className="text-gray-400" />
          <button className="ml-1 text-gray-300 hover:text-amber-400 transition-colors">
            <Star size={13} />
          </button>
        </div>

        <div className="flex items-center gap-1">
          <button className="flex items-center gap-1.5 text-[13px] text-gray-600 px-2.5 py-1.5 rounded-lg hover:bg-gray-100 transition-colors">
            <Filter size={13} className="text-gray-400" /> Filter
          </button>
          <button className="flex items-center gap-1.5 text-[13px] text-gray-600 px-2.5 py-1.5 rounded-lg hover:bg-gray-100 transition-colors">
            <Image size={13} className="text-gray-400" /> Media
          </button>
          <button className="text-[13px] text-gray-600 px-2.5 py-1.5 rounded-lg hover:bg-gray-100 transition-colors flex items-center gap-1.5">
      ...
      {calView === "Month" && (
        <>
          ...
          <div className="border-t border-[#f0f0f0] py-2 flex justify-center flex-shrink-0 bg-white">
            <button className="flex items-center gap-1.5 text-[13px] text-gray-400 hover:text-gray-600 transition-colors">
              ↓ Show next month
            </button>
          </div>
        </>
